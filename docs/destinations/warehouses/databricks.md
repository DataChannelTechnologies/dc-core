...
DataChannel uses OAuth Machine-to-Machine authentication to securely connect to Databricks using an Azure Service Principal. Tokens are automatically refreshed — no manual rotation required.
